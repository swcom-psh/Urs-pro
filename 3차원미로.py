...
MAP =[
     [
          ...
          [11,__,13,__,'w',16,17,'w',19,__,11,'w',13,14,'w',16,17,'w',__,20],
     ...
     [
          ...
          [11,__,__,__,__,__,17,18,19,10,__,12,__,'w',__,__,__,'x',__,20],
          [11,12,__,14,'w',__,__,__,__,__,__,__,__,14,__,'w',__,__,__,20],
          [11,12,13,14,15,16,17,18,19,10,11,12,13,14,15,16,17,18,'p',__],    
          ],
     [
          [11,12,13,14,15,'w',17,18,19,10,'w',12,13,'e',15,16,17,18,19,20],
          [11,__,__,__,__,__,17,__,19,__,11,'w',13,__,15,16,17,__,__,20],
...
for o in range(len(MAP)):
    for i in range(len(MAP[o])):
         for j in range(len(MAP[o][i])):
            if MAP[o][i][j]:
                if MAP[o][i][j] == 'p':
